...
function NotFound() {
    const svgStyle = { height: "4rem", width: '4rem', fill: "#0066CC" };
    return (
        <div className='text-center'>
            <Row className='align-items-center w-100 m-0' style={{height:'100vh'}}>
                <Col>
                    ...
                    <h1 className='mb-3'>Oops! Erro 404.</h1>
                    <Link to="/" type="button" className="btn primary-blue-background white">Voltar ao início</Link>
                </Col>
            </Row>
        </div>
    );
