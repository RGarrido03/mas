            ...
            <Container fluid className='px-3 text-center'>
                ...
                <div className="vstack gap-3 col-9 mx-auto">
                    ...
                    <div className="hstack mx-auto">
                        <Link to="/client/home" type="button" className="btn primary-blue-background white">Iniciar sessão</Link>
                        <div className="col-auto gx-0">&nbsp;</div>
                        <Link to="/client/register/1" type="button" className="btn border off-white-background middle-gray">Registar</Link>
                    </div>
                </div>
            </Container>
            <Footer />
