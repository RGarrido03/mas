        ...
        <div style={{ height: 'calc(100vh - 58.64px)', paddingTop: '58.64px'}} className="d-flex align-items-center">
            ...
            <Row className='align-items-center w-100 m-0' style={{ height: '100vh' }}>
                <Col>
                    ...
                    <h1 className='mb-1'>A aguardar um PT</h1>
                    <h2 className='mb-0'>Fizemos um pedido interno a vários Personal Trainers, para que te possamos atribuir um.</h2>
                    <h2 className='mb-3'>Esta atribuição pode demorar algumas horas.</h2>
