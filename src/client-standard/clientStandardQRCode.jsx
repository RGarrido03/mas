    ...
    return (
        <div style={{ marginTop: 'calc(58px + 16px)' }}>
            ...
            <Container fluid className='text-center' id='qrcodecontainer'>
                ...
                <p className='m-0 fw-light fs-7'>Este identifica-te como um Cliente com Plano Standard e permite-te aceder aos mais variados serviços disponíveis, limitados pelo teu plano.</p>
            </Container>
        </div>
    )
}

export default ClientStandardQRCode;