...
function ClientBasicExercise() {
    return (
        <div style={{ minHeight: 'calc(100vh - 58px - 57px)', paddingTop: '58px', paddingBottom: '57px' }}>
            ...
            <Navbar actor="client-basic" text="Exercício" />
            <Container fluid>
                {/* Workout insight */}
                ...
                <Link to="/client-basic/exercise/changeplan" className='text-decoration-none'>
                    <Card className="hover off-white-background mt-3">
                        <Card.Body className="row d-flex align-items-center">
                            <Col>
                                <Card.Text><span className="semibold">Editar</span> o plano de treino atual</Card.Text>
                            </Col>
                            <Col xs="auto">
...
export default ClientBasicExercise;