...
function ClientBasicMeasures() {
    return (
        <div style={{ marginTop: 'calc(58px + 16px)', marginBottom: 'calc(57px + 16px)' }}>
            ...
            <Navbar actor="client-basic" text="Medidas corporais" />
            <Container fluid>
                {/* Weekly plan */}
                <Card className="off-white-background mt-3">
                    <Card.Body>
                        <Row className='mb-2'>
                            ...
                            <Col xs="auto">
                                <Link to="/client-basic/measures/change"><i className='fa-solid fa-pen-to-square dark-gray m-0'></i></Link>
                            </Col>
                        </Row>
                        <Card.Text as="div">
                            <Row>
...
export default ClientBasicMeasures;