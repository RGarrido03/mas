        ...
        <div style={{ height: 'calc(100vh - 58.64px)', paddingTop: '58.64px' }} className="d-flex align-items-center">
            ...
            <Container fluid className='px-3 text-center'>
                ...
                <div className="vstack gap-3 col-12 mx-auto">
                    <Link to="/client-basic/register/2" className='text-decoration-none middle-gray'><i className="fa-solid fa-arrow-left dark-gray"></i>&nbsp;&nbsp;Voltar atrás</Link>
                    ...
                    <div className="mx-auto">
                        <Link to="/client-basic/register/4" type="button" className="btn primary-blue-background white">Próximo passo</Link>
                    </div>
                </div>
            </Container>
            <Footer />
...
export default ClientBasicRegister3;