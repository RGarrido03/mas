        ...
        <div style={{ height: 'calc(100vh - 58.64px)', paddingTop: '58.64px'}} className="d-flex align-items-center">
            ...
            <Container fluid className='px-3 text-center'>
                ...
                <div className="vstack gap-3 col-9 mx-auto">
                    <Link to="/client-basic/register/3" className='text-decoration-none middle-gray'><i className="fa-solid fa-arrow-left dark-gray"></i>&nbsp;&nbsp;Voltar atrás</Link>
                    <InputGroup>
                    ...
                    <div className="mx-auto">
                        <Link to="/client-basic/home" type="button" className="btn primary-blue-background white">Finalizar registo</Link>
                    </div>
                </div>
            </Container>
            <Footer />
...
export default ClientBasicRegister4;